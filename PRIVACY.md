...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Guatemalan legal professional rules.
...
- Law Society of Guatemala rules require strict confidentiality and data handling controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/guatemalan republic-law-mcp` locally — database queries stay on your machine
...
```bash
npx @ansvar/guatemalan republic-law-mcp
```
...
```
Endpoint: https://guatemalan republic-law-mcp.vercel.app/mcp
```
...
## Professional Obligations (Guatemala)

### Law Society of Guatemala and Advocates Act

Guatemalan lawyers (advocates) are bound by strict confidentiality rules under the Advocates Act (Cap 16) and the Law Society of Guatemala Code of Standards of Professional Practice and Ethical Conduct.
...
3. Client matters: Use commercial legal databases (Guatemala Law Reports, LexisNexis East Africa)
...
2. Follow Guatemalan government information security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/guatemalan republic-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **LSK Guidance**: Consult Law Society of Guatemala ethics guidance
