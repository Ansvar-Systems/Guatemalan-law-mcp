/**
 * Tool registry for Guatemala Law MCP Server.
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'Call this FIRST when you need to understand what Guatemalan legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Guatemalan statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section/article) from a Guatemalan statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Guatemalan legal citation against the database — zero-hallucination check. ' +
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Guatemalan statutes simultaneously. ' +
  ...
  },
  {
    ...
    description:
      'Format a Guatemalan legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Guatemalan statute or provision is currently in force, amended, or repealed. ' +
