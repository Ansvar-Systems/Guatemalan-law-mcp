...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'Guatemala Law MCP',
    version: context.version,
    jurisdiction: 'GT',
    description: 'Guatemala Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'Guatemala Justia',
        url: 'https://guatemala.justia.com',
        authority: 'Congreso de la Republica',
      },
    ],
    freshness: {
