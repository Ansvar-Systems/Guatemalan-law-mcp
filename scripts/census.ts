 ...
 *
 * Scrapes guatemala.justia.com/nacionales/leyes/ to enumerate Guatemalan laws.
 * Justia provides a reliable, structured index of Guatemalan legislation
 * with links to full-text HTML pages.
 *
 * Source: https://guatemala.justia.com/nacionales/leyes/
...
const BASE_URL = 'https://guatemala.justia.com';
const LAWS_INDEX = `${BASE_URL}/nacionales/leyes/`;

const USER_AGENT = 'guatemalan-law-mcp/1.0 (https://github.com/Ansvar-Systems/guatemalan-law-mcp; hello@ansvar.ai)';
...
async function main(): Promise<void> {
  ...
  console.log('============================\n');
  console.log('  Source: guatemala.justia.com/nacionales/leyes/');
  ...
  const census = {
    schema_version: '2.0', jurisdiction: 'GT', jurisdiction_name: 'Guatemala',
    portal: 'guatemala.justia.com', portal_url: LAWS_INDEX,
